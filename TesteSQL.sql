...
-- R:) Excluir os registros de outras tabelas que fazem referencia a esse cliente e então executar o seguinte comando: 
--        delete from tb_customer where cpf_cnpj = '<cpf do cliente desejado>';
